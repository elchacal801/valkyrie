...
> **MCP Tools**: `analyze_memory()` with plugins: pslist, pstree, netscan, malfind, cmdline, dlllist, handles
...
2. Invoke `analyze_memory(plugin="pstree")` — hierarchical process tree showing parent-child relationships
